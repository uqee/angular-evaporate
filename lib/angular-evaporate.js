              ...
              this[name] = function () {
                ...
                if (name === 'progress') {
                  ...
                  if (that.$percent) {
                    ...
                    var progress = (arg * 100).toFixed(2);
                    var delta = (new Date() - that.$started) / 1000;
                    var loaded = (progress * that.sizeBytes) / 100;
                    var totalSentBySecond = loaded / delta;
                    that.$speed = readableFileSize(totalSentBySecond) + '/s';
                  }
                }
