    ...
    // AngularEvaporateUpload
      ...
      .factory('AngularEvaporateUpload', ['$timeout', 'AngularEvaporateException',
        function ($timeout, AngularEvaporateException) {
           ...
           * @property {Number} $resumedAt
           * @property {Number} $pausingAt
           * @property {Number} $cancelledAt
           * @property {Number} $completeAt
           * @property {Number} $infoAt
           * @property {Number} $warnAt
           * @property {Number} $errorAt
           * @property {Number} $progressAt
           *
          ...
          var AngularEvaporateUpload = function (ae, config) {
            ...
            [
              ...
              this[name] = function () {
                ...
                if (name === 'progress') {
                  this.$percent = Math.round(arg * 10000) / 100;
                  this.$seconds = Math.round(
                    (100 - this.$percent) / this.$percent *
