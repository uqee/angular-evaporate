      ...
      .factory('AngularEvaporate', ['$timeout', 'Evaporate', 'AngularEvaporateUpload', 'AngularEvaporateException',
        function ($timeout, Evaporate, AngularEvaporateUpload, AngularEvaporateException) {
          ...
          // constructor
            ...
            AngularEvaporate.prototype.$change = function () {};
            AngularEvaporate.prototype.$click = function () {};
            ...
            link: function ($scope, $element) {
              ...
              $element.bind('change', function (event) {
                if ($scope.ae && $scope.ae.supported) {
                  ...
                  // callback for when selection is made and files are queued
                  $scope.ae.$change();
                }
              });
              $element.bind('click',function(){ $scope.ae.$click(); });
            }
          };
        }
      ]);
