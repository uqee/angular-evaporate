;(function () {
  ...
  // Evaporate
    ...
    app.value('Evaporate', Evaporate);

  // AngularEvaporateException

    app.factory('AngularEvaporateException', [
      function () {
  ...
  // AngularEvaporateUpload
    ...
    app.factory('AngularEvaporateUpload', ['$timeout', 'AngularEvaporateException',
  ...
  // AngularEvaporate
    ...
    app.factory('AngularEvaporate', ['$timeout', 'Evaporate', 'AngularEvaporateUpload', 'AngularEvaporateException',
  ...
  // angular-evaporate
    ...
    app.directive('angularEvaporate', [
      function () {
        return {
          restrict: 'A',
