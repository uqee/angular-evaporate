...
;(function (Evaporate) {
  ...
  angular
    ...
    .provider('eva', function () {
      ...
      this.$get = [function () {
        options.aws_url = (options.urlBase === undefined ? undefined : options.urlBase);
        return {
          _: new Evaporate(options),
          urlBase: (options.urlBase === undefined ? 'http://' + options.bucket + '.s3.amazonaws.com/' : options.urlBase)
        };
      }];
    })
