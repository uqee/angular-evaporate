      ...
      .directive('uploadProgress', [
        function () {
          return {
            ...
            template: "<span class=\"upload-progress\">" +
              "<span title=\"Pause\" ng-class=\"{'my-disabled':!upload.$started || upload.$pausing || upload.$paused || upload.$stopped}\" ng-click=\"upload.$pause({force:true})\">" +
              "<img class=\"icon icons8-Pause\" src=\"data:image/png;base64,\" width=\"24\" height=\"24\"></span>" +
              "<span title=\"Resume\" ng-class=\"{'my-disabled':!upload.$started || !upload.$paused || upload.$stopped}\" ng-click=\"upload.$resume()\">" +
              "<img class=\"icon icons8-Play\" src=\"data:image/png;base64,\" width=\"24\" height=\"24\"></span>" +
              "<span title=\"Cancel\" ng-class=\"{'my-disabled':!upload.$started || upload.$stopped}\" ng-click=\"$parent.$cancel()\">" +
              "<img class=\"icon icons8-Stop\" src=\"data:image/png;base64,\" width=\"24\" height=\"24\"></span>" +
              "<span>{{upload.$seconds ? upload.$speedStr + ' - ' + upload.$seconds + ' s' : \'\'}}</span>" +
              "<div class=\"m-r-sm m-l-sm progress  progress-mini\">" +
              "<div class=\"progress-bar progress-bar-primary progress-bar-striped\" ng-class=\"{'active':upload.$started&&!upload.$paused&&!upload.$stopped,'progress-bar-success':upload.$complete}\" ng-style=\"{'width':(upload.$percent||0)+\'%\'}\"></div></div></span>"
          };
        }
      ])
    // angular-evaporate

      .directive('angularEvaporate', [
        function () {
          return {
            restrict: 'A',
            ...
            link: function ($scope, $element) {
              ...
              $element.bind('change', function (event) {
                if ($scope.ae && $scope.ae.supported) {
                  ...
                  // process files
                  angular.forEach(event.target.files, function (file) { $scope.ae[fn]({ file: file }); });

                  // clear selection
                  if ($scope.ae.$rinserepeat) $element.val(null);
                }
              });
            }
          };
